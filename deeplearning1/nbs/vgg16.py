# See http://forums.fast.ai/t/keras-2-released/1956/42
# for updates for Keras2
...
class Vgg16():
    ...
    def fit(self, batches, val_batches, nb_epoch=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches, steps_per_epoch=max(batches.samples//batches.batch_size, 1), 
                                 epochs=nb_epoch,
                                 validation_data=val_batches,
                                 validation_steps=max(val_batches.samples//val_batches.batch_size, 1))
    ...
    def test(self, path, batch_size=8):
        ...
        return test_batches, self.model.predict_generator(test_batches, max(test_batches.samples//test_batches.batch_size,1))
